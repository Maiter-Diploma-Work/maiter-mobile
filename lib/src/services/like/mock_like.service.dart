...
class MockLikeService extends LikeService {
  ...
  Future<void> dislikeUser(DislikeDto like) async {
    print('A user with Id ${like.firstUserId} liked one with Id ${like.secondUserId}');
  }

  @override
  Future<void> likeUser(LikeDto like) async {
    print('A user with Id ${like.firstUserId} disliked one with Id ${like.secondUserId}');
  }
